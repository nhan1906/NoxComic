...
public class ItemListProfileRecyclerView extends RecyclerView.Adapter<ItemListProfileRecyclerView.ViewHolder> {

    private Context context;
    public ItemListProfileRecyclerView(Context context){
